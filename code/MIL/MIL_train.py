...
parser.add_argument('--train_lib', type=str, default=root, help='path to train MIL library binary')
parser.add_argument('--val_lib', type=str, default=root, help='path to validation MIL library binary. If present.')
